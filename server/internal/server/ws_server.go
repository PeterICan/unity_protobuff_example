...
import (
	...
	"proto_buffer_example/server/internal/subsystem/position"
...
func (p *webSocketServer) initAttachedSubsystem() {
	p.ControllerList = []base.ISubsystemController{
